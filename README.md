...
- `Dockerfile` - container image for the dashboard app
- `docker-compose.yml` - local container startup for the dashboard
- `Makefile` - short commands for build, test, lint, and security checks
...
Use the dashboard task board as your reading and checklist surface, then add a lint step, a Docker build, and a basic security scan so you can see the pipeline evolve one piece at a time.
